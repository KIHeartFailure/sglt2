...
The table shows the last dispension within 5 months prior to 2018-12-31 for all 
patients (also those NOT on sglt2 at index). Patients that die/emigrate are 
considered not to be available. 

```{r, child = "../src/sglt2end.Rmd"}
